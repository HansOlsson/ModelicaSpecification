...
\begin{semantics}
Allowed for class annotations.
The \lstinline{Diagram} annotation defines the icon view of the class.
...
The \lstinline!interaction! attribue specifies ineractive features, see \cref{user-input}.
