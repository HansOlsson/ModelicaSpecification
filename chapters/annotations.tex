...
An experiment annotation locally in the class completely defines the experiment.
If the class does not locally contain an experiment annotation it is inherited from the first base-class containing
an experiment annotation (if any).
\begin{nonnormative}
This implies that it may be useful to construct a partial model (e.g., a template for a number of similar test cases)
containing an experiment annotation, since the experiment applies to models inherting from this base class.
\end{nonnormative}
