...
Every virtual connection graph that contains a \lstinline!uniqueRoot! must have exactly one \lstinline!uniqueRoot! definition (and no normal or potential roots), before breakable branches are removed.
...
\begin{nonnormative}
This is used for checking that there are delayed transitions in loops involving parallel branches in the \lstinline!Modelica_StateGraph2! library.
\end{nonnormative}
\end{semantics}
\end{operatordefinition}
